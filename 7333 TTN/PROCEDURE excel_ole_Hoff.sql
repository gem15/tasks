...
begin
	...
	--> pz6707 --> ins_arg_excel ('Ýêçåìïëÿð ¹__' , 5 , 1);--Range("A5").Value = p_ne
	...
	ins_arg_excel ('ÊÎËÈ×ÅÑÒÂÎ ÌÅÑÒ-' ||p_KOL_VO_PALLETO_MEST , 19 , 1 );--Range("A19").Value = "ÊÎËÈ×ÅÑÒÂÎ ÌÅÑÒ-" & p_KOL_VO_PALLETO_MEST
...
--> yurmir *** 12.08.2018 pz6707 *** ins_arg_excel (P_A41 , 109 /*41*/ , 1 );--Range("A41").Value = P_A41
	...
	---------------------------------------------------
	alert_note('Ïðîäîëæèòü ïå÷àòü äðóãèõ ëèñòîâ ÒÒÍ');
	---------------------------------------------------
